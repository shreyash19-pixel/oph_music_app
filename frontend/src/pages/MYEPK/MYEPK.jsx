...
const MYEPK = () => {
    ...
    const fetchSpecialArtist = async () => {
        ...
        try {
            ...
            const response = await axiosApi.get(`/get-special-artist-detail?ophid=${ophid}`, {
                headers: headers,
            });
                    ...
                    <div className="relative z-50 container px-6 xl:px-16 lg:px-10 mx-auto pt-[120px] sm:pt-[200px]">
                        ...
                        <div className="grid grid-cols-3 gap-8 mb-12">
                            ...
                            <div className="flex flex-col col-span-3 sm:col-span-2">
                                ...
                                {artist.total_content > 0 && (<p className="text-primary mb-2 font-bold">
                        ...
                        {/* Songs Table */}
                        {artist.songs.length > 1 && (<table table className="w-full mb-12 text-xs sm:text-sm lg:text-base table-auto">
                            <thead>
                            ...
                            <tbody>
                                {artist?.songs.map((song, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="py-3 px-1 text-center">
                                            <div className="flex justify-center items-center h-full w-full">
                                                {song.duration_in_minutes && <SongDuration url={song.duration_in_minutes} />}
                                            </div>
                                        </td>
